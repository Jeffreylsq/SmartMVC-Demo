<%@page
	...
	pageEncoding="UTF-8" 
	import="java.util.List,cn.tedu.entity.Emp" 
 %>
<!DOCTYPE html>
<!--
        ...
        <div class="col-md-8">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">New Emploee INFO</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" action="saveEmp" method="post">
              <div class="box-body">
                <div class="form-group">
                  ...
                  id="ename" placeholder="Please enter name"
                  name="ename">
                </div>
<% 
...
%>
                ...
                <div class="form-group">
                  <label for="hiredate">Date
                  <input type="date" class="form-control" 
                  id="hiredate" placeholder="enter date"
                  name="hiredate">
                </div>
                <div class="form-group">
...
%>                 
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" 
                  id="sal" placeholder="Enter salary"
                  name="sal">
                </div>
                <div class="form-group">
                  <label for="comm">Bonus</label>
                  <input type="text" class="form-control" 
                  id="comm" placeholder="Enter Bonus"
                  name="comm">
                </div>
                <div class="form-group">
                  <label for="deptno">Dept-ID</label>
                  <input type="text" class="form-control" 
                  id="deptno" placeholder="Enter dept-no"
                  name="deptno">
                </div>
